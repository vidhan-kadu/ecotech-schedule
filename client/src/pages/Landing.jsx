...
import { Calendar, Clock, Globe, Link as LinkIcon, Sparkles, Shield } from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 64px)' }}>
      ...
      <section style={{
        ...
        <div className="animate-fadeInUp">
          ...
          <p style={{
            ...
            Set your availability, share your link, and let others book appointments with ease.
      ...
      <footer style={{
        ...
        © {new Date().getFullYear()} EcoTech Scheduler. Built with React.js & Express.js
      </footer>
    </div>
  );
}
